...
#' @slot color_map a character vector of colors in hexadecimal rgb format. 
...
#' @slot view the anatomical orientation of the layer view: type \code{AxisSet3D}
#' @slot zero_col the color of pixels with intensity of zero. This value overrides the color from the slot \code{color_map}
#' @slot alpha the transparency of the layer (0 to 1)
#' @export
setClass("Layer",
         representation=representation(vol="BrainVolume", color_map="vector", thresh="numeric", 
                                       view="AxisSet3D", view_space="BrainSpace", zero_col="character", alpha="numeric"))


#' Overlay
setClass("Overlay",
                  representation(layers="list", uspace="BrainSpace", view="AxisSet3D"))
