...
#' @slot xy_axis the axis indices of the xy plane
#' @slot xy_space the \code{BrainSpace} of the xy-plane
...
setClass("Layer",
         representation=representation(vol="BrainVolume", colorMap="vector", thresh="numeric", 
                                       axis="numeric", xy_axis="numeric", bbox="list", xy_space="BrainSpace",
                                       zero.col="character", alpha="numeric"))


#' Overlay
setClass("Overlay",
                  representation(layers="list", uspace="BrainSpace", axis="numeric"))
